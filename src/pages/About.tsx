...
const teamMembers = [
  ...
  },
  {
    name: 'Iggy',
    description:
      'Iggy is the team lead and responsible for the backend within the project. A former economist, he is passionate about web development. He likes new technologies and brought RTK Query into the project.',
        ...
        <Box>
          <div style={{ textAlign: 'justify' }}>
            <Typography variant="body2" color="text.secondary" sx={{ textIndent: '20px' }}>
              ...
              dedicated learners and experienced mentors, RS School fosters an environment conducive
              to growth and excellence. The institution prides itself on providing comprehensive
              training in cutting-edge technologies, with a strong focus on JavaScript and
              TypeScript, setting the stage for students to master these foundational languages.
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ textIndent: '20px' }}>
              {' '}
              ...
              honed throughout our time at RS School. From the basics of JavaScript to the advanced
              concepts of TypeScript and React, every lesson has been instrumental in bringing our
              e-commerce site to life.
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ textIndent: '20px' }}>
              {' '}
